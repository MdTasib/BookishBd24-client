            ...
            <div>
                ...
                <div className='lg:flex md:flex'>
                    <div className='w-[300px] mr-3'>
                        <img className='animate-pulse' src="https://png.pngtree.com/png-clipart/20220516/ourlarge/pngtree-obishasho-mullo-char-bangla-offer-label-png-image_4642251.png" alt="" />
                        <div className='mt-12'>
                            <img className='animate-bounce' src="https://png.pngtree.com/png-vector/20221030/ourmid/pngtree-bangla-discount-tag-up-to-10-off-png-image_6403888.png" alt="" />
                        </div>
                    </div>
                    <div className=' w-full md:w-[82%] mx-auto grid md:grid-cols-3 gap-y-4 mb-5'>
                        <div className='mx-7 max-h-min border-2 rounded hover:border-primary cursor-pointer p-2'>
                            <img className='block mx-auto' src="https://ds.rokomari.store/rokomari110/ProductNew20190903/260X372/270857a7a_198199.jpg" alt='' />
                            ...
                            <div class='px-4'>
                                ...
                                <span className='text-xs py-2 block'> অধ্যাপক (ডাঃ) মোঃ তৌফিকুর রহমান (ফারুক)</span>
                        ...
                        <div className='mx-7 max-h-min border-2 rounded hover:border-primary cursor-pointer p-2'>
                            <img className='block mx-auto' src="https://ds.rokomari.store/rokomari110/ProductNew20190903/260X372/7484be540_87341.jpg" alt='' />
                            <div className='relative'>
                                <a href='/' title='' class='crt-btn flex items-center justify-center'>
                                < FaShoppingCart className='text-white' />
                                </a>
                            ...
                            <div class='px-4'>
                                ...
                                <span className='text-xs py-2 block'> ড. খোন্দকার আব্দুল্লাহ জাহাঙ্গীর</span>
                        ...
                        <div className='mx-7 max-h-min border-2 rounded hover:border-primary cursor-pointer p-2'>
                            <img className='block mx-auto' src="https://ds.rokomari.store/rokomari110/ProductNew20190903/260X372/7d93a7652_150367.jpg" alt='' />
                            <div className='relative'>
                                <a href='/' title='' class='crt-btn flex items-center justify-center'>
                                < FaShoppingCart className='text-white' />
                                </a>
                            ...
                            <div class='px-4'>
                                ...
                                <span className='text-xs py-2 block'>খান বাহাদুর আহছানউল্লা</span>
