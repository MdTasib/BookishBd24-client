...
const NotFound = () => {
	return (
		<main class='h-screen w-full flex flex-col justify-center items-center bg-accent'>
			...
			<div class='bg-white font-bold border-2 border-primary px-2 text-sm rounded rotate-12 absolute'>
				Page Not Found
			</div>
			<button class='mt-5'>
				<a class='relative inline-block text-sm font-medium text-primary group focus:outline-none focus:ring'>
