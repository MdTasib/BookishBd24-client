	...
	return (
		<>
			{/* <div className='relative overflow-hidden bg-no-repeat bg-cover max-w-xs  cursor-pointer'>
				<img src={image} className='max-w-xs h-full' alt='Louvre' />
			...
			<div className='relative overflow-hidden bg-no-repeat bg-cover max-w-xs  cursor-pointer'>
				<img src={image} className='max-w-xs h-full' alt='Louvre' />
				<div className='absolute top-0 right-0 bottom-0 left-0 w-full h-full overflow-hidden opacity-0 transition duration-300 ease-in-out bg-gradient-to-r from-primary via-primary to-accent hover:opacity-70'></div>
			</div>
		</>
	);
};
